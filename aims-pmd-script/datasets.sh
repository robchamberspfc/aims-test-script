...
<http://environment.data.gov.uk/linked-data/catalog/datasets> dcat:record <http://environment.data.gov.uk/linked-data/catalog/datasets/entry/'$name'> .

# the record of the dataset in the catalog
<http://environment.data.gov.uk/linked-data/catalog/datasets/entry/'$name'> a dcat:CatalogRecord ;
    rdfs:label "'$name'" ;
